    ...
    this.props
      ...
      .then((response) => {
        if (response.data.errors && response.data.errors.length > 0) {
          ...
          this.props.history.push(userRoutes.preferences.path);
        }
      })
      .catch((error) => {
...
// onClickSubscribe, we will want to have the page redirected to a style survey (to="/style-preferences")
// where, as a user, we can select various style images

// may also want to change the title of the crate to reflect the style of the user
